            ...
            <Box position="fixed" left="0" top="0" borderColor="black" borderWidth={1} w={"8vw"} h={"90vh"} display={"flex"} alignItems={"top"} justifyContent={"center"}>
                <VStack>
                    ...
                    <Flex gap={5} direction={"column"} alignItems={"center"}>
                        <Button variant="ghost" borderRadius="full" onClick={() => setSelectedView('dm')}>
                            <Avatar.Root size={"lg"} >
                                <Avatar.Fallback name ="Direct Message"/>
                            </Avatar.Root>
                        </Button>
                        <Button variant="ghost" borderRadius="full" onClick={() => setSelectedView('general')}>
                            <Avatar.Root size={"lg"} >
                                <Avatar.Fallback name ="All-General Channels"/>
                            </Avatar.Root>
                        </Button>
                        <Button variant="ghost" borderRadius="full" onClick={() => setSelectedView('private')}>
                            <Avatar.Root size={"lg"} >
